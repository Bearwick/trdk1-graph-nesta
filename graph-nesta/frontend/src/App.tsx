    ...
    return (
      <div className="App">
        ...
        <div className="bg-background flex flex-col items-center">
          ...
          <div>
            <h1 className="text-4xl text-text underline underline-offset2">Om ODA-metoden</h1>
            <a href="/" download><p className="text-xs text-linkBlue underline underline-offset2 mb-5">Last ned oversettelse av NESTA-guiden <DownloadIcon sx={{ fontSize: "medium"}} /></p> </a>

          <div className="flex flex-row h-12 w-[65vw] mb-8 items-center ">
          ...
          <div className="flex flex-row h-50 w-[65vw] mb-8 items-center ">
            ...
            <p className="w-[45vw] h-100% text-text text-xs sm:text-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna 
            </p>
          </div>
