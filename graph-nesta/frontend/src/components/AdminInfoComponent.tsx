...
function AdminInfoComponent(props: AdminInfo) {
  ...
  return (
    <div className="bg-buttonDark h-24 sm:h-32 min-w-[8rem] sm:min-w-[14rem] text-white whitespace-nowrap px-5 py-2 sm:gap-2 flex flex-col cursor-pointer hover:drop-shadow-3xl hover:bg-buttonHover">
