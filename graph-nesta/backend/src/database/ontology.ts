...
const addCategories = async (
  ...
  const q1 = update(
    queries.addInference(specProblem, dataProduct, accessibleData, nodeName)
  )
  const q2 = update(
...
const addUser = async (
  ...
  return await update(
    queries.addUser(phone, email, affiliation, password, setAdmin)
  )
}
